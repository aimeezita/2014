...
{ name:'F12-StaffHired', row:12, col:6, n:0, condition: function(r){ return( r.isHired && r.isGlobant ); } },
{ name:'G12-StaffStaffed', row:12, col:7, n:0, condition: function(r){ return( ! r.isHired && r.isGlobant ); } },
{ name:'F13-ShadowHired', row:13, col:6, n:0, condition: function(r){ return( r.isHired && r.isShadow && ! r.isGlobant ); } },
{ name:'G13-ShadowStaffed', row:13, col:7, n:0, condition: function(r){ return( ! r.isHired && r.isShadow && ! r.isGlobant ); } },
{ name:'F14-ReplacementHired', row:14, col:6, n:0, condition: function(r){ return( r.isHired && r['Replacement'] === 'Yes' && ! r.isShadow && ! r.isGlobant ); } },
{ name:'G14-ReplacementStaffed', row:14, col:7, n:0, condition: function(r){ return( ! r.isHired && r['Replacement'] === 'Yes' && r.isShadow && ! r.isGlobant ); } },
