...
vmap <F8> :python debugger_command('step_over')
omap <F8> :python debugger_command('step_over')
...
silent only
cd ~/Dropbox/2014/jsxref/GloberSuggestionsLib
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 StaffSuggestions.gs
badd +0 Prototypes.gs
badd +0 Utils.gs
badd +0 FC_tests.gs
badd +0 Rules.gs
badd +0 Normalise.gs
badd +0 Dispersion.gs
badd +0 Library.MappingsDataset.gs
badd +0 Library_CCPOFileFinder.gs
badd +0 BestSuggestions.gs
badd +0 Library_ErrorListClass.gs
args StaffSuggestions.gs
edit StaffSuggestions.gs
...
1
normal! 0
tabedit Library.MappingsDataset.gs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit Library_CCPOFileFinder.gs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit Library_ErrorListClass.gs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
